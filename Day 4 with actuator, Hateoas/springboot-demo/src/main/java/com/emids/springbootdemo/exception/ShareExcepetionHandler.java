...
public class ShareExcepetionHandler {
	...
	@ExceptionHandler(value=InvalidFieldNameInJSONException.class)
	public ResponseEntity<String> InvalidFieldNameExceptionHandler(InvalidFieldNameInJSONException ex){
